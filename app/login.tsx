    ...
    try {
      ...
      if (error) {
        ...
        if (error.message.toLowerCase().includes('email not confirmed')) {
          Alert.alert(
            'Email Not Confirmed',
            'Please check your inbox and click the confirmation link first, then try logging in again.'
          );
      ...
      // On success the useAuth hook in _layout.tsx will automatically redirect to /(app)/home
    } catch (err) {
          ...
          <View style={styles.card}>
            ...
            <View style={styles.inputGroup}>
              ...
              <View style={styles.inputWrapper}>
                ...
                <TextInput
                  style={styles.input} placeholder="Your password" placeholderTextColor="#9CA3AF"
            ...
            >
              <LinearGradient colors={['#2563EB', '#3B82F6']} style={styles.loginBtnGradient} start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }}>
            ...
            <TouchableOpacity style={styles.registerBtn} onPress={() => router.push('/(auth)/register')} activeOpacity={0.7}>
...
const styles = StyleSheet.create({
  ...
  flex: { flex: 1 },
  headerGradient: { paddingTop: 40, paddingBottom: 50, alignItems: 'center' },
  ...
  registerBtn: { borderWidth: 1.5, borderColor: '#2563EB', borderRadius: 14, paddingVertical: 14, alignItems: 'center' },
